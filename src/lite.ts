...
class Peer extends Duplex {
    ...
    constructor (opts: any = {}) {
        ...
        // streamx is objectMode by default, so implement readable's
        // functionality
        ...
        // We prefer feature detection whenever possible, but sometimes that's
        // not possible for certain implementations.
        this._isReactNativeWebrtc = (typeof (this._pc as any)
    ...
    // HACK: it's possible channel.readyState is "closing" before
    // peer.destroy() fires
   ...
   */
    ...
    _destroy (cb, err) {
        ...
        setTimeout(() => {
            ...
            if (this._closingInterval) clearInterval(this._closingInterval)
            this._closingInterval = null
    ...
    _setupData (event) {
        if (!event.channel) {
            // In some situations `pc.createDataChannel()` returns `undefined`
            // (in wrtc),
        ...
        // HACK: Chrome will sometimes get stuck in readyState "closing",
    ...
    _onFinish () {
        ...
        const destroySoon = () => {
            setTimeout(() => this.__destroy(errCode(
        ...
        this._pc.createAnswer(this.answerOptions)
            .then(answer => {
                ...
                const sendAnswer = () => {
                    ...
                    if (!this.initiator) {
                        (this as any)._requestMissingTransceivers?.()
                    }
                }
    ...
    // statreports can come with a value array instead of properties
        const flattenValues = report => {
            if (Object.prototype.toString.call(report.values) ===
                '[object Array]') {
        ...
        if (this._pc.getStats.length === 0 || this._isReactNativeWebrtc) {
            ...
            (this._pc.getStats as any)(res => {
                // If we destroy connection in `connect` callback this code
    ...
    _maybeReady () {
        ...
        // https://github.com/js-platform/node-webrtc/issues/339
        const findCandidatePair = () => {
            ...
            this.getStats((err, items) => {
                ...
                const setSelectedCandidatePair = selectedCandidatePair => {
                    ...
                    } else if (typeof selectedCandidatePair
                    ...
                    if (remote && (remote.ip || remote.address)) {
                        ...
                        // TODO: remove this once Chrome 58 is released
                        remote = selectedCandidatePair.googRemoteAddress
                            .split(':')
                ...
                // Ignore candidate pair selection in browsers like Safari 11
                // that do not have any local or remote candidates
                ...
                // are unsupported, fallback to using setInterval to implement
                // backpressure.
                if (typeof this._channel!.bufferedAmountLowThreshold !==
                    'number') {
    ...
    _onSignalingStateChange () {
        ...
        if (this._pc.signalingState === 'stable') {
            ...
            // HACK: Firefox doesn't yet support removing tracks when
